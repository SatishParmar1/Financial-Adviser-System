function getBotResponse(input) {
    ...
    // Simple 
    if (input == "investment advicement") {
        return "Could you mind providing your financial details";
    }  
if (input == "Salary 25000") {
        return "Plaese provide your monthly expenses and inverstment percentage";
       
   }  
  if (input == "20% and 40%") {
        return "Thank you for your details. Click on your Portfolio to see your details.";
    } 
